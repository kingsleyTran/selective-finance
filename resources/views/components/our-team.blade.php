                ...
                <ul class="splide__list">
                    @foreach ($members as $member)
                        ...
                        <li class="splide__slide">
                            <article class="group relative overflow-hidden rounded-sm aspect-square bg-dark-green/10">
                                @if ($avatar)
                                    <img
                                ...
                                @endif
                                {{-- Overlay: name, role, phone, email --}}
                                <div class="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-dark-green/95 via-dark-green/50 to-transparent p-4 md:p-6">

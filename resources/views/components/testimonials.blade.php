<section class="mb-14 md:mb-28">
    <div class="mx-auto max-w-screen-2xl px-6">
        <div class="text-center mb-8 md:mb-16">
            ...
            <h3 class="text-3xl md:text-4xl lg:text-[56px] font-display font-medium text-dark-green uppercase">
                {!! $title !!}
            </h3>
        </div>
            ...
            <div class="relative splide__track">
                <ul class="splide__list">
                    ...
                    <li class="flex flex-col md:flex-row splide__slide md:border-y md:border-dashed border-black/20 md:py-6">
                        <div class="md:border-r border-dashed border-black/20 mb-6 md:mb-0 md:px-20">
                            <div class="flex items-center justify-center font-aboreto text-3xl md:text-[40px] leading-[130%] text-dark-yellow w-full md:w-[256px] h-[160px] md:h-[256px] bg-white uppercase">
                                {{ $testimonial->company }}
                            </div>
                        </div>
                        <div class="max-w-3xl mx-auto text-center md:text-left md:px-4">
                            ...
                            @endphp
                            <div>
                                <svg class="mx-auto md:mx-0" xmlns="http://www.w3.org/2000/svg" width="25" height="22" viewBox="0 0 25 22" fill="none">
                            ...
                            <div class="font-display text-xl md:text-[32px] leading-[100%] text-dark-green mb-4 md:mb-8 tracking-[-0.32px]">
                                {{ $quote }}
                            </div>
                            @if ($author)
                ...
                {{-- Custom arrows --}}
                <div class="absolute left-0 top-[80px] md:top-1/2 -translate-y-1/2">
                ...
                <div class="absolute right-0 top-[80px] md:top-1/2 -translate-y-1/2">
